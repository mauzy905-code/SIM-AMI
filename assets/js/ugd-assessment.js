    ...
    function createUgdAssessmentModule(deps) {
        ...
        function injectModalHtml() {
            ...
            wrapper.innerHTML = [
                ...
                '                          <path d="M40 42 L60 54 L80 42" />',
                '                          <path d="M40 42 L30 78" />',
                '                          <path d="M80 42 L90 78" />',
                '                          <path d="M45 86 L60 108 L75 86" />',
                '                          <path d="M60 108 L46 156" />',
                '                          <path d="M60 108 L74 156" />',
                '                        </g>',
                '                      </svg>',
                '                    </div>',
                ...
                '                          <path d="M38 46 L60 60 L82 46" />',
                '                          <path d="M38 46 L30 82" />',
                '                          <path d="M82 46 L90 82" />',
                '                          <path d="M44 90 L60 112 L76 90" />',
                '                          <path d="M60 112 L48 156" />',
                '                          <path d="M60 112 L72 156" />',
                '                          <path d="M48 58 L60 68 L72 58" />',
                '                        </g>',
                '                      </svg>',
                '                    </div>',
                ...
                '                          <path d="M64 44 L44 78" />',
                '                          <path d="M64 44 L78 78" />',
                '                          <path d="M64 92 C56 108 56 132 60 156" />',
                '                          <path d="M64 92 C72 108 72 132 70 156" />',
                '                          <path d="M64 54 C72 58 74 64 70 70" />',
                '                        </g>',
                '                      </svg>',
                '                    </div>',
                ...
                '                          <path d="M56 44 L38 78" />',
                '                          <path d="M56 44 L74 78" />',
                '                          <path d="M56 92 C48 108 48 132 50 156" />',
                '                          <path d="M56 92 C64 108 64 132 60 156" />',
                '                          <path d="M56 54 C48 58 46 64 50 70" />',
                '                        </g>',
                '                      </svg>',
                '                    </div>',
                '                  </div>',
